...
# df = pd.read_csv('/root/xinglin-data/satd/Dataset/23_Shades/OBrien_with_exp_zhipu_fp+ct+cmb.csv')
...
for NUM_EXAMPLES_IN_PROMPT in num_instances:
    ...
    file_name = 'Results/' + DATASET + '_Input-orig-' + INPUT + '_' + checkpoint.split('/')[-1] + icl_name
