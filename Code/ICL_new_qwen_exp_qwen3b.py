...
for NUM_EXAMPLES_IN_PROMPT in num_instances:
    ...
    # file_name = 'Results/' + DATASET + '_Input-exp-qwen_' + INPUT + '_' + checkpoint.split('/')[-1] + icl_name
    file_name = 'Results/' + 'labeldown' + DATASET + '_Input-exp-qwen_' + INPUT + '_' + checkpoint.split('/')[-1] + icl_name
