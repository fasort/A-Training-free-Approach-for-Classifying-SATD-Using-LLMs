...
df_retrieval = pd.read_csv('/root/xinglin-data/satd/retrieval_data/New_data_retrieval_with_exp_qwen32_100.csv')
...
df_retrieval = df_retrieval[['context','prompt_context','Category','Project', 'exp']]
...
for NUM_EXAMPLES_IN_PROMPT in num_instances:
    ...
    file_name = 'Results/' + DATASET + '_Input-cross-qwen-exp' + INPUT + '_' + checkpoint.split('/')[-1] + icl_name
