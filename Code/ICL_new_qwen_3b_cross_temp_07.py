...
checkpoint = "/root/xinglin-data/falv/models/Qwen/Qwen2___5-3B-Instruct"

# model = LLM(model="/root/xinglin-data/satd/models/LLM-Research/gemma-2-27b-it",gpu_memory_utilization=0.9)
model = LLM(model="/root/xinglin-data/falv/models/Qwen/Qwen2___5-3B-Instruct",gpu_memory_utilization=0.99)
