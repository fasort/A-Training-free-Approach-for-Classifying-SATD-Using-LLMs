...
df = pd.read_csv('/root/xinglin-data/satd/newData/OBrien_with_exp_zhipu_50tokens.csv')
print(len(df))
print(df.columns)
...
for NUM_EXAMPLES_IN_PROMPT in num_instances:
    ...
    file_name = 'Results/' + DATASET + '_Input-exp-diff-' + INPUT + '_' + checkpoint.split('/')[-1] + icl_name
